...
class _ProfileInfoPageState extends State<ProfileInfoPage> {
  ...
  void validateEdits() {
    if (_userSelectedFileImage == null) {
      ToastMessages().toastError("Veuillez selectionner une image", context);
    } else {
      showAlertDialog(context);
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    _columnTitle("Type de Compte"),
                    _columnDetail(userModelClass.accountType == "Trash Picker"
                        ? "Clent"
                        : "Agent de Salubrité"),
                    _columnTitle("Numéro de Contact"),
                    _columnDetail(userModelClass.contactNumber),
                    _columnTitle("Email"),
                    _columnDetail(userModelClass.email),
                    _columnTitle("Adresse"),
