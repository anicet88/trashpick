        ...
        Row(
          ...
          children: [
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                _statTitle("Total des ramassages "),
                SizedBox(
                  height: 10.0,
                ),
    ...
    return Column(
      ...
      children: [
        widget.accountType == "Trash Picker"
            ? _statTitle(
                "Programmez plus de ramassages de déchets pour débloquer la,")
            : _statTitle("Collectez plus de déchets pour débloquer le,"),
        SizedBox(
          height: 10.0,
        ),
        ...
        _badgeDesignsWidget('assets/images/badge_silver.png',
            "Argent $badgeType", "1000 Points"),
        SizedBox(
          height: 10.0,
        ),
        _badgeDesignsWidget(
            'assets/images/badge_gold.png', "Or $badgeType", "10000 Points"),
      ],
    );
  }
